...
public interface RepoProduct extends JpaRepository<Product, Integer>{
	...
	@Modifying
	@Transactional
	@Query(value = "UPDATE product SET product = :product, description = :description, price = :price, stock = :stock, status = 1, category_id = :category_id WHERE gtin = :gtin", nativeQuery = true)
	Integer activateProduct(@Param("gtin") String gtin, @Param("product") String product, @Param("description") String description,
			@Param("price") Double price, @Param("stock") Integer stock, @Param("category_id") Integer category_id);
	
	@Modifying
	@Transactional
	@Query(value = "INSERT INTO product (gtin,product,description,price,stock,status,category_id) VALUES(:gtin,:product,:description,:price,:stock,1,:category_id)", nativeQuery = true)
	void createProduct(@Param("gtin") String gtin, @Param("product") String product, @Param("description") String description,
			@Param("price") Double price, @Param("stock") Integer stock, @Param("category_id") Integer category_id);
	...
	@Query(value ="UPDATE product "
					...
					+ "WHERE product_id = :product_id AND status = 1", nativeQuery = true)
